                ...
                <div style={{
                  ...
                  <span style={{ fontSize: "13px", color: "var(--text-muted)" }}>
                    ...
                    <strong style={{ color: "var(--text-dark)" }}>
                      ...
                      {Math.min(currentPage * PLANS_PER_PAGE, plans.length)}
                    </strong>{" "}
                    of <strong style={{ color: "var(--text-dark)" }}>{plans.length}</strong> plans
                  </span>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: currentPage === 1 ? "var(--text-light)" : "var(--text-mid)",
                        fontSize: "14px",
                        fontWeight: "600",
                        transition: "all 0.15s",
                      }}
                      onMouseEnter={e => { if (currentPage !== 1) e.currentTarget.style.borderColor = "var(--brand)"; }}
                    ...
                    <button
                      ...
                      style={{
                        width: "34px", height: "34px",
                        display: "flex", alignItems: "center", justifyContent: "center",
                        background: currentPage === totalPages ? "var(--bg-subtle)" : "var(--bg-card)",
                        border: "1.5px solid var(--border)",
                        borderRadius: "8px",
                        cursor: currentPage === totalPages ? "not-allowed" : "pointer",
                        color: currentPage === totalPages ? "var(--text-light)" : "var(--text-mid)",
                        fontSize: "14px",
                        fontWeight: "600",
                        transition: "all 0.15s",
                      }}
                      onMouseEnter={e => { if (currentPage !== totalPages) e.currentTarget.style.borderColor = "var(--brand)"; }}
                      onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--border)"; }}
                    >
                      ›
                    </button>
